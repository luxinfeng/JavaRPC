...
import framework.core.remoting.transport.client.NettyRpcClient;
...
public class RpcClientProxy implements InvocationHandler {
     ...
     */
    private final NettyRpcClient rpcRequestTransport;
    private final RpcServiceProperties rpcServiceProperties;

    public RpcClientProxy(NettyRpcClient rpcRequestTransport, RpcServiceProperties rpcServiceProperties) {
    ...
    public RpcClientProxy(NettyRpcClient rpcRequestTransport) {
        this.rpcRequestTransport = rpcRequestTransport;
    ...
    private void check(RpcResponse<Object> rpcResponse, RpcRequest rpcRequest) {
        ...
        if (rpcResponse.getCode() == null || !rpcResponse.getCode().equals(RpcResponseCodeEnum.SUCCESS_CODE.getCode())) {
            throw new RpcException(RpcErrorMessageEnum.SERVICE_INVOCATION_FAILURE, INTERFACE_NAME + ":" + rpcRequest.getInterfaceName());
        }
    }
}
